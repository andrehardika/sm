			...
			<nav class="navbar navbar-default">
				<div class="container-fluid">
					...
					<div class="navbar-header">
						...
						<a class="logo-brand navbar-brand" href="{{ site_url("".pretty_url("homepage/".$slug)."") }}">
							...
							<ul class="nav navbar-nav navbar-right">
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/profil/".$list->slug)."") }}">{{ $list->judul }}</a></li>
										@endforeach
										@else
								...
								<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/berita")."") }}">Berita</a></li>
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/album")."") }}">Galeri Foto</a></li>
										<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/video")."") }}">Galeri Video</a></li>
									</ul>
								</li>
								<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/agenda")."") }}">Agenda</a></li>
								<li class="dropdown">
								...
								<li><a href="{{ site_url("".pretty_url("homepage/".$slug."/regulasi")."") }}">Regulasi</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										...
										<li><a href="{{ site_url("".pretty_url("homepage/".$list->slug)."") }}">{{ $list->nama }}</a></li>
										@endforeach
										@endif
									</ul>
								</li>
